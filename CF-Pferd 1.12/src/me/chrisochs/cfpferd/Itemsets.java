...
public class Itemsets {
	...
	public void setupStyleMenu(UUID uuid, Inventory inv) {
		...
		ItemStack istack0 = new ItemStack(Material.SNOWBALL);
		...
		ItemStack istack1 = new ItemStack(Material.SKELETON_SPAWN_EGG, 1);
		...
		ItemStack istack2 = new ItemStack(Material.WOLF_SPAWN_EGG, 1);
		...
		ItemStack istack3 = new ItemStack(Material.POLAR_BEAR_SPAWN_EGG, 1);
		...
		ItemStack istack4 = new ItemStack(Material.RED_STAINED_GLASS_PANE, 1);
		...
		ItemStack istack8 = new ItemStack(Material.RED_WOOL, 1);
	...
	public void setupColorMenu(UUID uuid, Inventory inv) {
		...
		// Schwarz
		ItemStack istack0 = new ItemStack(Material.INK_SAC, 1);
		ItemMeta istackMeta0 = istack0.getItemMeta();
		...
		istack0.setItemMeta(istackMeta0);
		// Braun
		ItemStack istack1 = new ItemStack(Material.COCOA_BEANS, 1);
		ItemMeta istackMeta1 = istack1.getItemMeta();
		...
		istack1.setItemMeta(istackMeta1);
		// Nougat
		ItemStack istack2 = new ItemStack(Material.BROWN_STAINED_GLASS_PANE, 1);
		ItemMeta istackMeta2 = istack2.getItemMeta();
		...
		istack4.setItemMeta(istackMeta4);
		// Grau
		ItemStack istack5 = new ItemStack(Material.GRAY_DYE, 1);
	...
	public void setupEquipmentMenu(UUID uuid, Inventory inv) {
		...
		ItemStack istack0 = new ItemStack(Material.IRON_HORSE_ARMOR);
		ItemMeta istackMeta0 = istack0.getItemMeta();
		...
		ItemStack istack2 = new ItemStack(Material.GOLDEN_HORSE_ARMOR);
		ItemMeta istackMeta2 = istack2.getItemMeta();
		...
		ItemStack istack4 = new ItemStack(Material.DIAMOND_HORSE_ARMOR);
		ItemMeta istackMeta4 = istack4.getItemMeta();
		...
		ItemStack istack6 = new ItemStack(Material.RED_STAINED_GLASS_PANE, 1);
		ItemMeta istackMeta6 = istack6.getItemMeta();
		if (style.equals("NONE")) {
			istackMeta6.setLore(actual);
		}
	...
	public void setupCoordinationMenu(UUID uuid, Inventory inv) {
		...
		ItemStack istack0 = new ItemStack(Material.BONE_MEAL, 1);
		ItemMeta istackMeta0 = istack0.getItemMeta();
		istackMeta0.setLore(Adult);
		istackMeta0.setDisplayName("§2§lAlter togglen");
		istack0.setItemMeta(istackMeta0);

		ItemStack istack2 = new ItemStack(Material.INK_SAC);
		ItemMeta istackMeta2 = istack2.getItemMeta();
		istackMeta2.setLore(Farbe);
		istackMeta2.setDisplayName("§2§lFarbe editieren");
		istack2.setItemMeta(istackMeta2);

		ItemStack istack4 = new ItemStack(Material.SKELETON_SPAWN_EGG, 1);
		ItemMeta istackMeta4 = istack4.getItemMeta();
		istackMeta4.setLore(Muster);
		istackMeta4.setDisplayName("§2§lMuster editieren");
		istack4.setItemMeta(istackMeta4);

		ItemStack istack6 = new ItemStack(Material.DIAMOND_HORSE_ARMOR);
		ItemMeta istackMeta6 = istack6.getItemMeta();
		...
		/*
		 * ItemStack istack8= new ItemStack(Material.SKULL_ITEM, 1, (short) 2); ItemMeta
		 * istackMeta8 = istack8.getItemMeta(); istackMeta8.setLore(Art);
